...
pub fn run(cli_args: CliArgs) {
    ...
    let specta_builder = Builder::<tauri::Wry>::new()
        .commands(collect_commands![
            ...
            commands::search::search_transcript,
            commands::confidence::get_low_confidence_words,
            commands::confidence::verify_word,
            commands::confidence::verify_all_words,
            commands::vocabulary::get_vocabulary_suggestions,
            commands::vocabulary::apply_vocabulary_corrections,
            commands::vocabulary::add_to_vocabulary,
            commands::vocabulary::remove_from_vocabulary,
            ...
            commands::cleanup::apply_cleanup,
            commands::silence::analyze_silence,
            commands::silence::apply_silence_removal,
            commands::punctuation::analyze_punctuation,
            commands::punctuation::apply_punctuation_corrections,
            commands::disfluency::cleanup_smart_duplicates,
            commands::project::save_project,
            commands::project::load_project,
            commands::speaker::get_speakers,
            commands::speaker::auto_assign_speakers,
            commands::speaker::merge_speakers,
            commands::speaker::assign_speaker_to_range,
            commands::speaker::clear_speakers,
