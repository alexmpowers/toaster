; Custom NSIS template for Toaster with portable mode support.
...
Function PageLeaveInstallType
  ...
  ${If} $0 = ${BST_CHECKED}
    ...
    ; --- PORTABLE MODE --- Switch default directory to Desktop\Toaster for portable
...
Function .onInit
  ...
  ; or the legacy empty marker created by older Toaster releases. Require Data/
...
Section Install
  ...
  ${If} $PortableMode = 1
    ...
    FileWrite $0 "Toaster Portable Mode"
    FileClose $0
