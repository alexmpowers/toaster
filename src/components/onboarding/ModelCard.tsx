      ...
      <div className="flex justify-between items-center w-full">
        <div className="flex flex-col items-start flex-1 min-w-0">
          <div className="flex items-center gap-3 flex-wrap">
            <h3
              className={`text-base font-semibold text-black/70 dark:text-white/70 ${isClickable ? "group-hover:text-black dark:group-hover:text-white" : ""} transition-colors`}
            >
              {displayName}
            </h3>
      ...
      <div className="flex items-center gap-3 w-full -mb-0.5 mt-0.5 h-5">
        ...
        {onDelete && (status === "available" || status === "active") && (
          <Button
            ...
            className="flex items-center gap-1.5 ms-auto text-text/50 hover:text-text hover:bg-mid-gray/10"
          >
