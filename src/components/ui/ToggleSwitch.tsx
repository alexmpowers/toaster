...
interface ToggleSwitchProps {
  ...
  /**
   * Optional element rendered alongside the switch in the same control
   * slot. Use for sibling affordances like feedback links on
   * Experimental rows — avoids wrapping the whole component in another
   * SettingContainer and producing a double-label.
   */
